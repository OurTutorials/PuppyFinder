...
.controller('SurveyController', SurveyController);
  ...
  SurveyController.$inject = ['$state', '$compile', '$scope', '$window', '$location', 'QuestionList', 'Result'];

  function SurveyController($state, $compile, $scope, $window, $location, QuestionList, Result){
